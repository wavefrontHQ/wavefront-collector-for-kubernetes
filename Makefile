...
setup:
	GOARCH=$(ARCH) CGO_ENABLED=0 go install github.com/pointlander/peg
...
test-proxy: $(REPO_DIR)/cmd/test-proxy/metric_grammar.peg.go clean fmt vet
