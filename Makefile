...
release:
	sudo docker run --rm --privileged harbor-repo.vmware.com/dockerhub-proxy-cache/multiarch/qemu-user-static@sha256:c772ee1965aa0be9915ee1b018a0dd92ea361b4fa1bcab5bbc033517749b2af4 --reset -p yes
