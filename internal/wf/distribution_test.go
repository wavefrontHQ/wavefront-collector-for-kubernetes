...
func TestDistribution(t *testing.T) {
    ...
    t.Run("ToFrequency", func(t *testing.T) {
        t.Run("coverts cumulative to frequency distribution", func(t *testing.T) {
        ...
        t.Run("converts cumulative to frequency with negative centroids", func(t *testing.T) {
            density := wf.NewCumulativeDistribution(
                "some.distribution",
                "somesource",
                map[string]string{"sometag": "somevalue"},
        ...
        t.Run("does not convert cumulative distributions with only a single infinite upper bound", func(t *testing.T) {
            density := wf.NewCumulativeDistribution(
                "some.distribution",
                "somesource",
                map[string]string{"sometag": "somevalue"},
        ...
        t.Run("converts cumulative distributions with a single bound", func(t *testing.T) {
            density := wf.NewCumulativeDistribution(
                "some.distribution",
                "somesource",
                map[string]string{"sometag": "somevalue"},
        ...
        t.Run("doesn't convert cumulative distributions with no centroids", func(t *testing.T) {
            density := wf.NewCumulativeDistribution(
                "some.distribution",
                "somesource",
                map[string]string{"sometag": "somevalue"},
